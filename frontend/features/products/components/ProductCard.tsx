    ...
    >
        ...
        <div className="flex-1 space-y-1 animate-in fade-in-0 slide-in-from-left-2 duration-500 delay-200">
          ...
          >
            <h3
              ...
              } font-trendy font-semibold text-warm-gray-900 line-clamp-2 group-hover:text-primary-600 transition-all duration-300 group-hover:translate-x-0.5 transform`}
            >
              {product.name}
            </h3>
          </Link>
      ...
      >
        <Link
          href={`/products/${product.slug}`}
          className={cn(
            "relative block w-full h-full rounded-2xl overflow-hidden transition-all duration-500 ease-out border border-warm-gray-200 group-hover/card-container:border-primary-300 group-hover/card-container:shadow-2xl group-hover/card-container:shadow-primary-500/10 group/card",
            compact
              ? "group-hover/card-container:scale-[1.01]"
              : "group-hover/card-container:scale-[1.02]"
          )}
        >
          ...
          >
            ...
            <Image
              ...
              fill
              className={cn(
                "object-contain transition-all duration-700 ease-out p-1.5 rounded-2xl",
                showHoverImage
                  ? "opacity-100 group-hover/card-container:opacity-0 group-hover/card-container:scale-110"
                  : "opacity-100 group-hover/card-container:scale-110"
              )}
            ...
            {showHoverImage && (
              <Image
                ...
                alt={product.name}
                fill
                className="object-contain transition-all duration-700 ease-out delay-100 absolute inset-0 opacity-0 group-hover/card-container:opacity-100 group-hover/card-container:scale-110 p-1.5 rounded-2xl"
                sizes={compact ? "96px" : "25vw"}
          ...
          >
            <div
              className={cn(
                ...
                compact
                  ? "text-[8px] px-1 py-0.5 rounded-md"
                  : "text-[9px] sm:text-[10px] md:text-sm px-1 sm:px-1.5 md:px-3 py-0.5 md:py-1.5"
              )}
            >
              <Sparkles
                className={cn(
            ...
            >
              <div
                className={cn(
                  ...
                  compact
                    ? "px-1 py-0.5 text-[8px] rounded-md"
        ...
        {isOutOfStock && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm z-30 pointer-events-none rounded-2xl">
            <span className="bg-warm-gray-900 text-white px-4 py-2 rounded-2xl text-sm font-semibold">
              Out of Stock
            </span>
          </div>
        )}
        ...
        {!isOutOfStock && (
          <div
            className={cn(
              "absolute inset-0 flex items-center justify-center transition-all duration-500 ease-out z-30 bg-linear-to-t from-black/60 via-black/40 to-transparent opacity-0 group-hover/card-container:opacity-100 rounded-2xl pointer-events-none",
              compact &&
            ...
            <button
              className={cn(
                ...
                compact
                  ...
                  : "px-4 py-2 sm:px-6 sm:py-3 md:px-7 md:py-3.5 text-[10px] sm:text-xs md:text-sm gap-1.5 sm:gap-2 rounded-xl"
              )}
              aria-label={
                requiresSelection
        ...
        >
          ...
          {effectiveStock > 0 && effectiveStock < LOW_STOCK_THRESHOLD && (
            ...
            >
              <div
                className={cn(
                  "flex justify-between font-bold uppercase tracking-wider text-primary-600",
              ...
              >
                <div
                  className="h-full bg-linear-to-r from-primary-400 to-primary-600 rounded-full animate-pulse"
                  style={{

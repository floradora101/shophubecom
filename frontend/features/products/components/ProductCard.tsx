  ...
  return (
    <div className="group flex flex-col w-full">
      ...
      <Link
        ...
        className={`relative ${
          compact ? "aspect-square w-24 h-24" : "aspect-square"
      ...
      >
        ...
        {hasDiscount && discountPercent > 0 && !compact && !hasPriceRange && (
          <div className="absolute top-3 left-3 z-sticky animate-in fade-in-0 slide-in-from-left-2 duration-500">
            <div className="font-bold text-xs md:text-sm px-2.5 md:px-3 py-1 md:py-1.5 shadow-xl shadow-red-500/20 text-white rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-red-500/30 group/badge bg-linear-to-br from-red-500 to-red-600">
              <Sparkles className="inline-block mr-1 transition-transform duration-300 group-hover/badge:rotate-12 group-hover/badge:scale-110 animate-pulse h-3 w-3" />
        ...
        {hasDiscount && discountPercent > 0 && !compact && !hasPriceRange && (
          <div className="absolute top-3 right-3 z-sticky animate-in fade-in-0 slide-in-from-right-2 duration-500 delay-100">
            <div className="bg-white/95 backdrop-blur-sm text-xs font-semibold border border-primary-300 text-primary-600 px-2 py-1 rounded-lg transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-lg group/limited">
              <Clock className="inline-block mr-1 transition-transform duration-300 group-hover/limited:rotate-12 h-3 w-3" />
              Limited
            </div>
          </div>
        )}
      ...
      <div
        className={`${
          compact ? "mt-1 space-y-0.5 min-h-10" : "mt-3 space-y-1 min-h-16"
        } flex flex-col justify-end animate-in fade-in-0 slide-in-from-bottom-2 duration-500 delay-200`}
      >

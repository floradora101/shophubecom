      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 h-[500px] md:h-[600px]">
        ...
        >
          <div
            ...
            className="w-full px-8 py-12 md:px-12 md:py-16 lg:px-16 lg:py-20 animate-fade-in-up max-w-2xl"
          >
            {/* Badge */}
            <div
            ...
            >
              <span
                className="inline-block rounded-full bg-primary-500 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-white shadow-md"
            ...
            {/* Title */}
            <h2
              className="mb-5 text-4xl font-bold leading-[1.1] text-gray-900 md:text-5xl lg:text-6xl animate-fade-in-up"
              style={{
                animationDelay: "0.2s",
            ...
            {currentProduct.description && (
              <p
                className="mb-8 line-clamp-2 text-base leading-relaxed text-gray-600 md:text-lg animate-fade-in-up max-w-lg"
                style={{
                  animationDelay: "0.3s",
                  fontFamily: "var(--font-poppins), sans-serif",
                  lineHeight: "1.7",
            ...
            >
              <div className="flex flex-col gap-3">
                <div className="flex items-baseline gap-3">
                  <span
                    className="text-5xl font-bold text-primary-600 md:text-6xl lg:text-7xl"
                    style={{
                      fontFamily: "var(--font-poppins), sans-serif",
                ...
                {currentProduct.stock > 0 && (
                  <span
                    className="inline-block w-fit rounded-full bg-green-50 border border-green-200 px-4 py-1.5 text-sm font-medium text-green-700"
                    style={{ fontFamily: "var(--font-poppins), sans-serif" }}
                  >
            ...
            >
              <Link href={`/products/${currentProduct.slug}`}>
                <Button
                  size="default"
                  className="px-8 py-3 text-sm font-semibold shadow-md group transition-all duration-200 hover:scale-[1.02] hover:shadow-lg rounded-lg"
                  style={{ fontFamily: "var(--font-poppins), sans-serif" }}
                >

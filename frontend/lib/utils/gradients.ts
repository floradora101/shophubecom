...
export const gradients = {
  ...
  textPrimary: "bg-gradient-to-r from-primary-600 to-primary-600",
  ...
  // Button gradients
  buttonPrimary:
    "bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-600",

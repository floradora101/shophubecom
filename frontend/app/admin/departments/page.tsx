...
export default function DepartmentsPage() {
  ...
  const handleDelete = (id: string) => {
    if (window.confirm("Are you sure you want to delete this department?")) {
      toast.success("Department deleted (mock)");
    }
  };
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <Heading level="h2">Departments</Heading>
          <Text className="text-warm-gray-500">
            Manage your homepage department spotlight sections.
          </Text>
        </div>
        ...
        <div className="p-4 border-b border-warm-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-warm-gray-50/30">
          ...
          <div className="flex items-center gap-3">
            <div className="text-xs text-warm-gray-400 font-medium hidden md:block">
              {filteredAndSortedDepartments.length} departments
            </div>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-40 rounded-lg p-1 shadow-lg border-warm-gray-100">
                        ...
                        <DropdownMenuItem asChild>
                          <Link href={`/admin/departments/${dept.id}/edit`} className="rounded-lg cursor-pointer flex items-center gap-2 px-2 py-2">
              ...
              {filteredAndSortedDepartments.length === 0 && (
                <tr>
                  <td colSpan={5} className="py-20 text-center">
                    ...
                    <Text className="text-warm-gray-500 font-medium">No departments found</Text>
                  </td>
                </tr>
              )}
            </tbody>

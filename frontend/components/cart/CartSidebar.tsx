      ...
      <aside className="absolute right-0 top-0 flex h-full w-full max-w-md flex-col bg-white shadow-2xl">
        <header className="flex items-center justify-between border-b px-5 py-4">
          ...
          <button
            type="button"
            onClick={() => toggleCart(false)}
            className="rounded-full p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-800 focus-visible:outline focus-visible:outline-primary-500"
                  ...
                  <div className="flex flex-1 flex-col gap-2">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="rounded-full p-1 text-gray-400 hover:bg-gray-200 hover:text-gray-700 focus-visible:outline focus-visible:outline-primary-500"

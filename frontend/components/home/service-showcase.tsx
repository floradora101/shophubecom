          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={service.title}
                  className="group relative bg-white/95 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-white/30 hover:shadow-2xl hover:shadow-primary-500/15 transition-all duration-700 hover:-translate-y-3 min-h-[380px] flex flex-col overflow-hidden"
                  style={{
